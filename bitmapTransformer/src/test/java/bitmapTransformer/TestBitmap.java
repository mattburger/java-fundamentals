...
public class TestBitmap {
    ...
    public void testAppReadsFile_success(){
        Bitmap classUnderTest = new Bitmap("src/main/resources/input2.bmp", "src/main/resources/", "output.bmp");
        assertEquals("getBitmap should return Success", "Success!", classUnderTest.getBitmap());
    }

    @Test
    public void testAppReadsFile_fail(){
        Bitmap classUnderTest = new Bitmap("src/src/main/resources/input2.bmp", "src/main/resources/", "output.bmp");
    ...
    public void testAppWritesFile_success(){
        Bitmap classUnderTest = new Bitmap("src/main/resources/input2.bmp", "src/main/resources/output.bmp", "output");
        assertEquals("writeToFile should return Success", "Success!", classUnderTest.writeToFile());
    }

    @Test
    public void testAppWritesFile_fail(){
        Bitmap classUnderTest = new Bitmap("src/src/main/resources/input2.bmp", "src/main/main/resources/output.bmp", "output");
        //change to assert failure later
